...
describe("Formattazione testo: Sottolineato ", () => {

  it("gestisce correttamente Inserimento, Applicazione e Rimozione del sottolineato", () => {
