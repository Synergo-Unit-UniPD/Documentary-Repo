  ...
  <header class="topbar" @click.self="closeMenus">
    <div class="topbar-top">
      ...
      <div class="file-actions">
        <span
          class="status"
          :class="{ unsaved: saveStatus === 'Modifiche non salvate' }"
        >
          {{ saveStatus }}
        </span>
        ...
        <button class="tool-button primary" title="Salva la nota" @click="emit('save')">
          <svg class="icon" viewBox="0 0 24 24" fill="none">
            <path d="M5 4H16L19 7V19C19 19.6 18.6 20 18 20H6C5.4 20 5 19.6 5 19V5C5 4.4 5.4 4 6 4H16Z" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round" />
        ...
        <button class="tool-button" title="Importa un file Markdown" @click="emit('open')">
          <svg class="icon" viewBox="0 0 24 24" fill="none">
            <path d="M12 4V13M12 13L15 10M12 13L9 10" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M5 15V18C5 19.1 5.9 20 7 20H17C18.1 20 19 19.1 19 18V15" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" />
          </svg>
          Importa
        </button>
        ...
        <div class="dropdown">
          <button class="tool-button" title="Esporta la nota" @click.stop="exportMenuOpen = !exportMenuOpen">
            <svg class="icon" viewBox="0 0 24 24" fill="none">
              <path d="M12 15V4M12 4L9 7M12 4L15 7" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M5 15V18C5 19.1 5.9 20 7 20H17C18.1 20 19 19.1 19 18V15" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" />
            </svg>
            Esporta
          </button>
    ...
    <div class="toolbar-groups">
      <div class="tool-group">
        ...
        <div class="group-buttons">
          <button class="tool-button square" title="Grassetto" @click="emit('format', FormatType.BOLD)"><strong>G</strong></button>
          <button class="tool-button square" title="Corsivo" @click="emit('format', FormatType.ITALIC)"><em>I</em></button>
          <button class="tool-button square" title="Sottolineato" @click="emit('format', FormatType.UNDERLINE)"><span style="text-decoration: underline">S</span></button>
          <button class="tool-button square" title="Barrato" @click="emit('format', FormatType.STRIKETHROUGH)"><span style="text-decoration: line-through">B</span></button>
          <button class="tool-button square" title="Citazione" @click="emit('format', FormatType.QUOTE)">&rdquo;</button>
      ...
      <div class="tool-group">
        ...
        <div class="group-buttons">
          <button class="tool-button square" title="Elenco puntato (clic di nuovo per rimuovere)" @click="emit('list', ListOperationType.CREATE_LIST, ListType.UNORDERED)">&bull;</button>
          <button class="tool-button square" title="Elenco numerato (clic di nuovo per rimuovere)" @click="emit('list', ListOperationType.CREATE_LIST, ListType.ORDERED)">1.</button>
          <button class="tool-button square" title="Aumenta rientro" @click="emit('list', ListOperationType.INDENT_ITEM)">&rarr;</button>
          <button class="tool-button square" title="Riduci rientro" @click="emit('list', ListOperationType.OUTDENT_ITEM)">&larr;</button>
        </div>
      </div>
      ...
      <div class="tool-group">
        ...
        <div class="group-buttons">
          ...
          <div class="dropdown">
            <button class="tool-button square" title="Modifica tabella" @click.stop="tableMenuOpen = !tableMenuOpen">&#8942;</button>
      ...
      <div class="tool-group">
        ...
        <div class="group-buttons">
          <div class="dropdown">
            <button class="tool-button ai-button" @click.stop="aiMenuOpen = !aiMenuOpen; hatMenuOpen = false">
              <svg class="icon" viewBox="0 0 24 24" fill="none">
