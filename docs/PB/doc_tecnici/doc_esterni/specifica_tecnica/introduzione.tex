...
Documenti interni del progetto, citati per versione (ogni versione è una revisione immutabile, già registrata nel relativo registro delle modifiche):
\begin{itemize}
...
Documentazione tecnica di terze parti, citata puntualmente alla pagina rilevante; trattandosi di risorse web soggette a variazione, ciascuna riporta la data di ultimo accesso:
\begin{itemize}
