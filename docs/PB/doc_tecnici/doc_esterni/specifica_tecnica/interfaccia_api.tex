...
Questa struttura unificata consente di aggiungere nuove operazioni AI (rispettando l'Open/Closed Principle, Sezione~\ref{sec:design-pattern}) senza introdurre nuovi endpoint o nuovi contratti di comunicazione: è sufficiente registrare una nuova strategia lato Backend.
