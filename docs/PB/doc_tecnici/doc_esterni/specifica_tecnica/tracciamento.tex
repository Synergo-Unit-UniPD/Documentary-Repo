...
Al fine di garantire che l'architettura progettata e le tecnologie scelte soddisfino le funzionalità concordate, si fornisce di seguito la tracciabilità tra le componenti architetturali descritte in questo documento e i requisiti individuati in \link{link_analisi_requisiti}{Analisi dei Requisiti} v1.8.0, Sezione 4 -- Requisiti, a cui si rimanda per la descrizione testuale completa di ciascun requisito.
...
\begin{xltabular}{\textwidth}{|>{\centering\arraybackslash}p{2.6cm}|X|c|c|}
	...
	R77 & Esportazione della nota in PDF, HTML e JSON. & Obbligatorio & In corso \\ \hline
	...
	R1-Q-O -- R6-Q-O & Copertura di test, documentazione tecnica, versionamento Git, test di integrazione con i servizi LLM. & Obbligatorio & In corso \\ \hline
