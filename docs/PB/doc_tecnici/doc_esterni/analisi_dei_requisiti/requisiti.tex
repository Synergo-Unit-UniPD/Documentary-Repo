...
proponente e dall'analisi del dominio applicativo.
...
\begin{longtable}{|p{2.5cm}|p{2.2cm}|p{6.8cm}|p{2.7cm}|}
	...
	% ---- Gestione elaborazione AI (Nuovi) ----
	\textbf{R72-F-O} & Obbligatorio & Il sistema deve mostrare all'utente una visualizzazione continua dello stato di avanzamento durante l'elaborazione AI. & \hyperlink{uc...}{UC...}, Analisi del dominio \\ \hline
	\textbf{R73-F-O} & Obbligatorio & Il sistema deve permettere all'utente di interrompere manualmente una richiesta in corso inviata al modello LLM. & \hyperlink{uc...}{UC...}, Verbale Esterno \\ \hline
	\textbf{R74-F-O} & Obbligatorio & Il sistema deve visualizzare la proposta generata dall'AI all'interno di un modale dedicato, separato dal testo della nota. & \hyperlink{uc...}{UC...}, Capitolato \\ \hline
	...
	% ---- Opzionali: DB remoto ----
	\textbf{R78-F-Op} & Opzionale & Il sistema deve permettere la creazione di una nuova nota vuota associando il titolo inserito dall'utente. & \hyperlink{uc61}{UC61}, Capitolato \\ \hline
	\textbf{R79-F-Op} & Opzionale & Il sistema deve permettere l'eliminazione di una nota previa conferma esplicita da parte dell'utente. & \hyperlink{uc62}{UC62}, \hyperlink{uc62.1}{UC62.1}, \hyperlink{uc62.2}{UC62.2}, Capitolato \\ \hline
	\textbf{R80-F-Op} & Opzionale & Il sistema deve notificare l'utente in caso di errore tecnico o del file system durante l'eliminazione di una nota. & \hyperlink{uc62.3}{UC62.3}, Analisi del dominio \\ \hline
	\textbf{R81-F-Op} & Opzionale & Il sistema deve permettere la registrazione di un nuovo utente tramite email e password, con validazione dei dati inseriti. & \hyperlink{uc66}{UC66}, \hyperlink{uc66.1}{UC66.1}, \hyperlink{uc66.2}{UC66.2}, Capitolato \\ \hline
	\textbf{R82-F-Op} & Opzionale & Il sistema deve permettere l'autenticazione dell'utente tramite credenziali; deve notificare in caso di credenziali errate. & \hyperlink{uc67}{UC67}, \hyperlink{uc67.1}{UC67.1}, Capitolato \\ \hline
	\textbf{R83-F-Op} & Opzionale & Il sistema deve permettere il logout dell'utente autenticato. & \hyperlink{uc68}{UC68}, Capitolato \\ \hline
	\textbf{R84-F-Op} & Opzionale & Il sistema deve permettere la visualizzazione della lista delle note salvate nel servizio remoto con nome e data di ultima modifica; deve notificare in caso di errore. & \hyperlink{uc69}{UC69}, \hyperlink{uc69.1}{UC69.1}, Capitolato \\ \hline
	\textbf{R85-F-Op} & Opzionale & Il sistema deve permettere il salvataggio della nota corrente nello spazio remoto associato al profilo utente; deve notificare in caso di errore di sincronizzazione. & \hyperlink{uc70}{UC70}, \hyperlink{uc70.1}{UC70.1}, Capitolato \\ \hline
	\textbf{R86-F-Op} & Opzionale & Il sistema deve permettere l'apertura di una nota dalla lista delle note salvate nel servizio remoto; deve notificare in caso di errore nel caricamento. & \hyperlink{uc71}{UC71}, \hyperlink{uc71.1}{UC71.1}, Capitolato \\ \hline
...
\begin{longtable}{|p{2.5cm}|p{2.2cm}|p{6.8cm}|p{2.7cm}|}
	...
	\textbf{R1-Q-O} & Obbligatorio & Il sistema dovrà essere corredato di test automatici con una code coverage minima dell'80\% sui casi d'uso principali. & Capitolato \\ \hline
	\textbf{R2-Q-O} & Obbligatorio & Il codice sorgente e la documentazione devono essere pubblicati su repository pubblico. & Capitolato \\ \hline
	\textbf{R3-Q-D} & Desiderabile & Il progetto dovrebbe rispettare i requisiti open source dell'azienda proponente nella scelta della licenza di distribuzione. & Capitolato \\ \hline
...
\begin{longtable}{|p{2.5cm}|p{2.2cm}|p{6.8cm}|p{2.7cm}|}
	...
	\textbf{R1-V-O} & Obbligatorio & L'applicazione deve essere basata su tecnologie web standard (HTML5, CSS3, JavaScript/TypeScript) ed eseguibile tramite browser, senza installazione di software aggiuntivo. & Capitolato \\ \hline
	...
	\textbf{R4-V-Op} & Opzionale & Il sistema utilizza un database PostgreSQL\textsubscript{G} configurato a livello applicativo per la memorizzazione remota delle note. & VE-1.4, VE-7.1 \\ \hline
	\textbf{R5-V-O} & Obbligatorio & L'applicazione deve essere compatibile e pienamente supportata sui seguenti browser: Google Chrome (e derivati Chromium come Edge), Mozilla Firefox e Apple Safari. & VE-7.1 \\ \hline
...
\begin{longtable}{|p{2.5cm}|p{2.2cm}|p{6.8cm}|p{2.7cm}|}
	...
	\textbf{R1-P-O} & Obbligatorio & Il rendering dell'anteprima Markdown deve aggiornarsi in tempo reale durante la digitazione, entro 1 secondo dalla modifica del contenuto dell’editor. & Capitolato, Analisi del dominio \\ \hline
	\textbf{R2-P-O} & Obbligatorio & A fronte di una connessione di rete stabile verso le API, il sistema deve garantire una visualizzazione continua e reattiva dello stato di caricamento per l'intera durata dell'elaborazione AI, indipendentemente dai tempi di risposta del modello. & Analisi del dominio, VE-6.1 \\ \hline
