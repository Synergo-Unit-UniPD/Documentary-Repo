...
\begin{longtable}{|p{2.5cm}|p{2.2cm}|p{6.8cm}|p{2.7cm}|}
	...
	\textbf{R75-F-O} & Obbligatorio & Il sistema deve permettere il salvataggio della nota corrente in un file \texttt{.md} nel file system locale; deve notificare in caso di errore. & \hyperlink{uc146}{UC146}, \hyperlink{uc146.1}{UC146.1}, Capitolato \\ \hline
	\textbf{R76-F-O} & Obbligatorio & Il sistema deve permettere il caricamento di un file \texttt{.md} esistente dal file system locale nell'editor; deve notificare in caso di file non valido o corrotto. & \hyperlink{uc147}{UC147}, \hyperlink{uc147.1}{UC147.1}, Capitolato \\ \hline
	\textbf{R77-F-O} & Obbligatorio & Il sistema deve permettere l'esportazione della nota nei formati PDF, HTML e JSON; deve notificare in caso di errore durante la conversione. & \hyperlink{uc148}{UC148}, \hyperlink{uc148.1}{UC148.1}, \hyperlink{uc149}{UC149}, \hyperlink{uc149.1}{UC149.1}, \hyperlink{uc150}{UC150}, \hyperlink{uc150.1}{UC150.1}, Capitolato \\ \hline

	% ---- Opzionali: DB remoto ----
	\textbf{R78-F-Op} & Opzionale & Il sistema deve permettere la creazione di una nuova nota vuota associando il titolo inserito dall'utente. & \hyperlink{uc144}{UC144}, Capitolato \\ \hline
	\textbf{R79-F-Op} & Opzionale & Il sistema deve permettere l'eliminazione di una nota previa conferma esplicita da parte dell'utente. & \hyperlink{uc145}{UC145}, \hyperlink{uc145.1}{UC145.1}, \hyperlink{uc145.2}{UC145.2}, Capitolato \\ \hline
	\textbf{R80-F-Op} & Opzionale & Il sistema deve notificare l'utente in caso di errore tecnico o del file system durante l'eliminazione di una nota. & \hyperlink{uc145.3}{UC145.3}, Analisi del dominio \\ \hline
	\textbf{R81-F-Op} & Opzionale & Il sistema deve permettere la registrazione di un nuovo utente tramite email e password, con validazione dei dati inseriti. & \hyperlink{uc151}{UC151}, \hyperlink{uc151.1}{UC151.1}, \hyperlink{uc151.2}{UC151.2}, Capitolato \\ \hline
	\textbf{R82-F-Op} & Opzionale & Il sistema deve permettere l'autenticazione dell'utente tramite credenziali; deve notificare in caso di credenziali errate. & \hyperlink{uc152}{UC152}, \hyperlink{uc152.1}{UC152.1}, Capitolato \\ \hline
	\textbf{R83-F-Op} & Opzionale & Il sistema deve permettere il logout dell'utente autenticato. & \hyperlink{uc153}{UC153}, Capitolato \\ \hline
	\textbf{R84-F-Op} & Opzionale & Il sistema deve permettere la visualizzazione della lista delle note salvate nel servizio remoto con nome e data di ultima modifica; deve notificare in caso di errore. & \hyperlink{uc154}{UC154}, \hyperlink{uc154.1}{UC154.1}, Capitolato \\ \hline
	\textbf{R85-F-Op} & Opzionale & Il sistema deve permettere il salvataggio della nota corrente nello spazio remoto associato al profilo utente; deve notificare in caso di errore di sincronizzazione. & \hyperlink{uc155}{UC155}, \hyperlink{uc155.1}{UC155.1}, Capitolato \\ \hline
	\textbf{R86-F-Op} & Opzionale & Il sistema deve permettere l'apertura di una nota dalla lista delle note salvate nel servizio remoto; deve notificare in caso di errore nel caricamento. & \hyperlink{uc156}{UC156}, \hyperlink{uc156.1}{UC156.1}, Capitolato \\ \hline
...
\begin{longtable}{|p{2.5cm}|p{2.2cm}|p{6.8cm}|p{2.7cm}|}
	...
	\textbf{R5-V-O} & Obbligatorio & L'applicazione deve essere compatibile e pienamente supportata sui seguenti browser: Google Chrome (e derivati Chromium come Edge), Mozilla Firefox e Apple Safari. & VE-7.3 \\ \hline
