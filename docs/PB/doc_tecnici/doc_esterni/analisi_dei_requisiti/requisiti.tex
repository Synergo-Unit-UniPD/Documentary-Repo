...
\begin{longtable}{|p{2.5cm}|p{2.2cm}|p{6.8cm}|p{2.7cm}|}
	...
	\textbf{R25-F-O} & Obbligatorio & Il sistema deve permettere l'inserimento un intestazione Markdown (livello H1) per il testo digitato successivamente. & \hyperlink{uc25}{UC25}, Capitolato, VE-5.1 \\ \hline
