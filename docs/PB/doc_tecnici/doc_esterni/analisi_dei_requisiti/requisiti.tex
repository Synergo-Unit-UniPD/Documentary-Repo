...
\textbf{R3-P-O} & Obbligatorio & Il tempo di avvio dell'applicazione, dal caricamento della pagina alla piena interattività dell'editor, deve attestarsi entro i 3 secondi in condizioni di rete standard, coerentemente con i tempi medi osservati (2-3 secondi). & Interno \\ \hline
	...
	\textbf{R5-P-O} & Obbligatorio & Il sistema deve applicare alle richieste di elaborazione AI un timeout massimo di durata elevata (indicativamente 5 minuti), tale da non interrompere prematuramente le elaborazioni testuali più lunghe; al superamento della soglia la richiesta viene interrotta automaticamente con notifica di errore, mentre l'utente mantiene comunque la possibilità di interruzione manuale in qualsiasi momento (R73-F-O). & Interno \\ \hline
