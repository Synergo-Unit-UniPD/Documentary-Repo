...
È emersa la necessità di procedere all'aggiornamento della specifica tecnica e alla revisione dell'Analidi Dei Requisiti (ADR) per garantire il pieno allineamento con le scelte implementative effettuate.
