...
\begin{itemize}
    ...
    {Piano di Progetto\textsubscript{G}, v1.18.1};
    ...
    {Piano di Qualifica\textsubscript{G}, v1.3.0};
    ...
    {Analisi dei Requisiti\textsubscript{G}, v1.0.0};

    \item
    \link{https://synergo-unit-unipd.github.io/Second-Brain/docs/PB/doc_tecnici/doc_esterni/analisi_stato_arte/analisi_stato_arte.pdf}
    {Analisi dello Stato dell'Arte\textsubscript{G}, v1.0.0};
