...
\begin{itemize}
    \item \textbf{Baseline attuale}: PB\textsubscript{G}; il gruppo si trova nella
    fase di sviluppo dei requisiti, delle scelte tecnologiche e della
...
I processi precedentemente attivati rimangono operativi, e vengono formalmente normati e introdotti i seguenti processi per supportare lo sviluppo del codice di produzione:

\begin{itemize}
    \item codifica estesa del prodotto e definizione dell'architettura;
    \item norme di codifica e naming conventions;
    \item Dependency Injection;
    \item test automatici (Unit e Integration testing);
    \item analisi statica del codice (Linting e Formattazione);
    \item Continuous Integration tramite GitHub Actions;
    \item gestione rigorosa delle Pull Request.
\end{itemize}

L'introduzione di questi processi si riflette nei corrispondenti capitoli dei Processi Primari, Organizzativi e di Supporto.