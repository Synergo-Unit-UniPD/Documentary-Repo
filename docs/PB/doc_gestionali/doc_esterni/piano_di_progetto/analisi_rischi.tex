...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|c|X|}
		...
		\textbf{Probabilità / Impatto} & Media/Alta \\
		\hline
		\textbf{Piano di Mitigazione} & Organizzare incontri periodici di validazione; condividere frequentemente gli avanzamenti e recepire i feedback nei successivi aggiornamenti della pianificazione \\
		\hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|c|X|}
		...
		\textbf{Probabilità / Impatto} & Media/Media \\
		\hline
		\textbf{Piano di Mitigazione} & Refactoring\textsubscript{G} mirato sulla base delle criticità rilevate; code review; riserva di capacità dedicata al debito tecnico \\
		\hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|c|X|}
		...
		\hline
		\textbf{Descrizione} & Inserimento accidentale nel repository di credenziali, token, file \texttt{.env} o dati sensibili durante lo sviluppo del prodotto \\
		\hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|c|X|}
		...
		\textbf{Probabilità / Impatto} & Bassa/Media \\
		\hline
		\textbf{Piano di Mitigazione} & Obiettivi di sprint chiari e verificabili; monitoraggio del carico di lavoro; coinvolgimento continuo del team \\
		\hline
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|c|X|}
		...
		\hline
		\textbf{Piano di Contingenza} & Aggiornamento del Preventivo a Finire; ribilanciamento delle ore residue tra ruoli e membri, mantenendo invariato il vincolo economico complessivo \\
		\hline
	\end{tabularx}
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|c|X|}
		\hline
		\textbf{Codice} & \textbf{RO8} \\
		\hline
		\textbf{Descrizione} & Rallentamento della comunicazione con l'azienda proponente e riduzione della disponibilità dei membri del team in periodi di ferie o di ridotta reperibilità \\
		\hline
		\textbf{Probabilità / Impatto} & Alta/Media \\
		\hline
		\textbf{Piano di Mitigazione} & Pianificare in anticipo le comunicazioni con il proponente in prossimità di periodi feriali noti; tenere costantemente aggiornato il team sulle richieste in sospeso; isolare le attività dipendenti da risposte esterne per non bloccare il flusso principale di lavoro \\
		\hline
		\textbf{Piano di Contingenza} & Proseguire lo sviluppo sulle attività non dipendenti dalla risposta esterna (lavoro a compartimenti stagni); intensificare la comunicazione interna per compensare le assenze o i ritardi di reperibilità dei singoli membri \\
		\hline
	\end{tabularx}
	\caption{Scheda rischio RO8}
\end{table}
...
I rischi vengono rivalutati al termine di ogni sprint, a partire dal consuntivo
di periodo e a valle della Sprint Retrospective\textsubscript{G}. Il consuntivo
permette di rilevare attività svolte, consumi effettivi e scostamenti rispetto al
preventivo; la retrospettiva permette invece di individuare le cause degli
scostamenti e delle criticità emerse.

Tali evidenze vengono utilizzate per aggiornare il registro dei rischi, definire
eventuali misure correttive, aprire issue\textsubscript{G} dedicate e migliorare
la pianificazione futura.

Qualora un rischio si manifesti o cambi significativamente il proprio profilo di
probabilità o impatto, il gruppo aggiorna il Piano di Progetto, rivede la
pianificazione a breve o lungo termine e recepisce l'effetto della correzione nel
Preventivo a Finire.