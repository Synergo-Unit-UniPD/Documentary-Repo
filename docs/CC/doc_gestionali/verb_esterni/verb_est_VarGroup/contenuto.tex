...
\begin{itemize}
	\item Potenzialmente verranno fornite le chiavi API oppure verrà usato qualche SLM open source, dipende dalla data di inizio del progetto e dal tipo di agenti da sviluppare
\end{itemize}
...
\begin{longtable}{c p{12cm}}
    ...
    \textbf{VE-1.1} & Utilizzare le chiavi API oppure SLM open source fornito dall'azienda \\
    \textbf{VE-1.2} & Testing per verificare che la logica delle risposte sia deterministica e della qualità dell'output \\
    \textbf{VE-1.3} & Raggiungere il livello di automazione richiesto dall'azienda \\
    \textbf{VE-1.4} & Seguire una serie di sessioni di formazione sui temi necessari per progettazione, ricerca, studio e proposte di soluzioni in autonomia \\
\end{longtable}
