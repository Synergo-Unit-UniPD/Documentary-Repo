...
\begin{enumerate}[leftmargin=1.8em, itemsep=3pt]
    ...
    \item Disponibilità di esempi o test esistenti per i ``Sei Cappelli per Pensare''
    ...
    \item Requisiti di interfaccia e usabilità
    \item Chatbot con messaggi precompilati e accessibilità
\end{enumerate}
...
\begin{itemize}[leftmargin=1.5em, itemsep=3pt]
    \item Il proponente ha confermato disponibilità a fornire supporto \textit{su richiesta} laddove necessario, in particolare riguardo all'invocazione di LLM (chiamate API, struttura dei messaggi, parametri principali).
...
\textbf{Discussione:}\\
Il gruppo ha chiesto se il proponente disponga di esempi o casi di test già esistenti da utilizzare come riferimento per migliorare e valutare i prompt relativi all'implementazione dei ``Sei Cappelli per Pensare''.

\vspace{0.3cm}
\textbf{Risposta e accordi con il proponente:}
\begin{itemize}[leftmargin=1.5em, itemsep=3pt]
    \item Non sono disponibili esempi o test predefiniti.
    \item L'approccio atteso è quello dell'esplorazione sperimentale del \textbf{prompt engineering}, verificando autonomamente fino a che punto il modello linguistico sia in grado di applicare la metodologia dei cappelli in modo efficace.
...
\begin{itemize}[leftmargin=1.5em, itemsep=3pt]
    ...
    \item Il meccanismo preferito è: \textbf{selezione del testo} → bottone corrispondente al cappello desiderato → risposta visualizzata in un \textit{pop-up} o pannello laterale.
    ...
    \begin{itemize}[leftmargin=1.5em, itemsep=2pt]
        ...
        \item \textit{Chatbot}: l'utente esprime liberamente un'intenzione/un \textbf{compito}  (es.\ ``voglio applicare il cappello critico'') e il chatbot individua la funzionalità corrispondente, agendo da \textbf{mediatore tra linguaggio naturale e funzionalità}.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Presentazione della proposta architetturale e dello stack tecnologico scelto
        \item Revisione del backlog iniziale e delle priorità di sviluppo del PoC
