...
\begin{enumerate}
	\item Revisione\textsubscript{G} e approvazione verbale esterno per comunicazione mail con l'azienda Zucchetti, invio mail con richiesta di firma e proposta di riunione da remoto
	\item Comunicazione via mail con azienda Var Group.
	\item Riorganizzazione delle norme di progetto\textsubscript{G} secondo lo standard ISO/IEC 12207:1995\textsubscript{G}
	\item Standard interni di gestione e nomenclatura di branch\textsubscript{G}, task\textsubscript{G} e versionamento.
	\item Aggiornamento sito e documentazione.
	\item Ordinamento documenti.
	\item Protezione del branch main sulla repository\textsubscript{G} GitHub.
...
\begin{itemize}
	...
	\item Aggiornamento solo tramite pull request\textsubscript{G}.
...
Azioni operative:
\begin{itemize}
	\item Ridefinizione delle ore per ruolo\textsubscript{G} per ottenere un compromesso tra costo e distribuzione equilibrata del lavoro.
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{OdG preliminare\textsubscript{G}:} Revisione generale dei documenti per la candidatura\textsubscript{G}, verifica di eventuale risposta da parte delle aziende Zucchetti e Var Group.
\end{itemize}