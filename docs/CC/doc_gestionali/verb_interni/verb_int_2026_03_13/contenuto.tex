...
\begin{enumerate}
    \item Scelta della tecnologia per il tracciamento dei task\textsubscript{G}.
    \item Definizione delle misurazioni\textsubscript{G}: tempi, costi e strumenti di raccolta.
    \item Convenzioni di nomenclatura per file, branch\textsubscript{G} e glossario.
    \item Pianificazione dell’invio delle email alle aziende.
    \item Assegnazione delle attività operative per candidatura\textsubscript{G} e documentazione.
\end{enumerate}
...
Il gruppo ha discusso la necessità di adottare un sistema strutturato per il tracciamento delle attività e la raccolta delle misurazioni\textsubscript{G}.

\textbf{Motivazione:} garantire un processo di gestione dei task\textsubscript{G} coerente, misurabile e integrato con gli strumenti utilizzati dal gruppo.

Azioni operative:
\begin{itemize}
    \item Adozione di GitHub Project\textsubscript{G} come strumento principale per il tracciamento dei task.
    \item Ogni task avrà un identificativo GitHub univoco, utilizzato come riferimento per le misurazioni.
    \item Le misurazioni (ruolo\textsubscript{G}, tempo previsto\textsubscript{G}, tempo effettivo\textsubscript{G}) saranno raccolte tramite un Google Form\textsubscript{G} collegato a un foglio Excel condiviso.
    \item Lo storico delle issue\textsubscript{G} rimarrà su GitHub; le misurazioni saranno gestite tramite Excel.
    \item Tutti i membri leggeranno la documentazione ufficiale di GitHub Project.
\end{itemize}

\subsection{Convenzioni di nomenclatura}
\textbf{Motivazione:} garantire uniformità e coerenza nella struttura della documentazione e nell’organizzazione del repository\textsubscript{G}.

Convenzioni stabilite:
\begin{itemize}
    \item Utilizzo del pedice \textbf{G} per i termini presenti nel glossario.
    \item Struttura documentale\textsubscript{G} nella repository:
    \begin{itemize}
...
Convenzioni stabilite:
\begin{itemize}
    \item Le decisioni dei verbali interni saranno identificate tramite il codice VI-y.x\textsubscript{G}.
    \item Le attività operative (To-Do) saranno identificate tramite il codice T-y.z\textsubscript{G}.
...
\textbf{Motivazione:} distribuire in modo chiaro e tracciabile le attività necessarie per la candidatura\textsubscript{G}.

Azioni operative:
\begin{itemize}
    \item Stesura del verbale: Sofia.
    \item Creazione del template per i task.
    \item Configurazione GitHub Project.
    \item Studio delle Norme di Progetto\textsubscript{G} (ISO/IEC 21270:1995\textsubscript{G}): Filippo, Roberto, Sofia.
    \item Analisi del preventivo costi\textsubscript{G}: Armando, Ricardo, Francesco.
...
\begin{longtable}{c p{12cm}}
    ...
    \textbf{VI-2.1} & Adozione di GitHub Project\textsubscript{G} come strumento principale per il tracciamento dei task. \\
    \textbf{VI-2.2} & Raccolta delle misurazioni tramite Excel con eventuale Google Form\textsubscript{G} collegato. \\
    \textbf{VI-2.3} & Definizione delle convenzioni di nomenclatura: pedice G, cartelle interne/esterne, branch\textsubscript{G} per persona. \\
    \textbf{VI-2.4} & Adozione delle regole formali per l’identificazione di decisioni (VI-y.x\textsubscript{G}) e task (T-y.z\textsubscript{G}). \\
    \textbf{VI-2.5} & Invio email alle aziende Zucchetti ed Eggon per richiesta informazioni. \\
    \textbf{VI-2.6} & Assegnazione dei compiti operativi per candidatura\textsubscript{G} e documentazione. \\
\end{longtable}
...
\begin{longtable}{c c p{4.5cm} l l}
    ...
    \textbf{T-2.7} & VI-2.6 & Studio Norme di Progetto. & Filippo, Roberto, Sofia & 2026-03-17 \\
...
\begin{itemize}
    ...
    \item \textbf{OdG preliminare\textsubscript{G}:} Revisione GitHub Project, verifica misurazioni, avanzamento candidatura con inizio stesura ``Valutazione capitolati'', ``Norme di Progetto'' e ``Preventivo dei Costi e Assegnazione dei Ruoli''.
\end{itemize}
