...
\begin{itemize}
	...
	\item {Esecuzione automatizzata dei decision tree\textsubscript{G} per ciascun requisito EN18031.}
...
\begin{itemize}
    ...
    \item {Analisi sicurezza OWASP\textsubscript{G}: audit completo tramite strumenti e regole OWASP.}
    \item {Analisi documentazione: verifica della presenza e qualità di README, API\textsubscript{G} docs e guide.}
...
\begin{itemize}
    ...
    \item {Database: MongoDB\textsubscript{G} o PostgreSQL\textsubscript{G}}
    \item {CI/CD\textsubscript{G} e integrazioni: GitHub Actions}
    \item {Architettura cloud: AWS\textsubscript{G}}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Contro:}
        \begin{itemize}
            ...
            \item raggiungere il 70\% di code coverage\textsubscript{G} su un'architettura distribuita e basata su agenti IA richiede uno sforzo notevole.
        \end{itemize}
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Contro:}
        \begin{itemize}
            ...
            \item l'utilizzo di modelli di IA soprattutto negli ambiti proposti dal progetto ("Detective delle relazioni" e "Specchio intelligente") potrebbe rivelarsi complesso data la specificità e accuratezza di cui necessitano.
        \end{itemize}
\end{itemize}

\vspace{0.3cm}
\textbf{Valutazione sintetica:} \\
Il progetto nonostante il supporto proposto dall'azienda è comunque molto complesso ed ampio il che potrebbe rivelarsi problematico dati i 
...
\begin{itemize}
    ...
    \item AI Co-pilot per Consulenti del Lavoro (CdL) cioè un modulo per la gestione documentale che permette l’automatizzazione (grazie al riconoscimento OCR\textsubscript{G} e classificazione AI) di riconoscimento del documento, estrazione dei destinatari, generazione lista di distribuzione, invio tracciato e conservazione dei documenti.
\end{itemize}
\vspace{0.3cm}
...
\begin{itemize}
	...
	\item Ai Assistant deve permettere la creazione di contenuti completi (titolo, testo, immagine di copertina) a partire da un prompt con adattamento automatico del tono e dello stile rispetto a quelli selezionati, salvataggio del prompt, sistema di rating e possibilità di revisione\textsubscript{G}.
\end{itemize}
...
\begin{itemize}
	\item \textbf{Pro:}
        \begin{itemize}
            ...
            \item la presenza della tabella con rischi, impatti e mitigazioni è molto utile per avere già un'idea dei problemi che potranno presentarsi e di come affrontarli.
        \end{itemize}
	\item \textbf{Contro:}
        \begin{itemize}
...
\begin{itemize}
    ...
    \item impartire comandi base al LLM per:
        ...
        \end{itemize}
\item Implementazione di comandi di critica del testo secondo il modello dei “sei cappelli per pensare\textsubscript{G}” di Edward De Bono.
