...
\begin{itemize}
  ...
  \item \textbf{Codice task}: i task sono identificati dal codice \texttt{T-y.z},
...
\begin{itemize}
  ...
  \item uno script Python contenuto in \texttt{python\_glossary\_automation/}
        che applica automaticamente il pedice G\textsubscript{G} alla prima
...
\begin{enumerate}
  ...
  \item \textbf{Revisione\textsubscript{G}}: il Verificatore\textsubscript{G},
  ...
  \item \textbf{Pubblicazione}: superata la revisione, il documento viene
        ...
        repository\textsubscript{G} tramite pull~request\textsubscript{G},
...
\begin{itemize}
  ...
  \item \textbf{Script Python} (\texttt{python\_glossary\_automation/}):
        automatizza l'applicazione del pedice G\textsubscript{G} alla prima
...
repository\textsubscript{G} GitHub centralizzato.
...
Ogni membro apre un branch\textsubscript{G} dedicato per lavorare su un singolo
...
\begin{enumerate}
  ...
  \item Aggiornamento del numero di versione secondo il
        Semantic~Versioning\textsubscript{G}.
  ...
  \item Integrazione nel branch \texttt{main} tramite pull~request\textsubscript{G}.
...
attivato al termine di ogni stesura e prima di ogni pull~request\textsubscript{G}.
...
\begin{itemize}
  \item \textbf{Esito positivo}: il Verificatore approva la
        pull~request\textsubscript{G}; il documento è integrato nel branch
        \texttt{main}.
  \item \textbf{Esito negativo}: il Verificatore lascia commenti analitici sulla
        pull~request\textsubscript{G} e la chiude senza merge. Il Redattore è tenuto
