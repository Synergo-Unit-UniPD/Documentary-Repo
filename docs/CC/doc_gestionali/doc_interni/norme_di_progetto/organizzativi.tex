...
\begin{itemize}
  ...
  \item assuma ogni ruolo\textsubscript{G} per un tempo totale congruo;
...
\begin{tabularx}{\textwidth}{l c X}
  ...
  Amministratore\textsubscript{G}
    ...
    & Assicura l'efficienza di procedure, strumenti e tecnologie a supporto
      del \textit{way of working\textsubscript{G}}; redige e mantiene aggiornate le Norme di
      Progetto. \\[6pt]
...
\textit{Dichiarazione Degli Impegni\textsubscript{G}} e nei task\textsubscript{G} su
...
Ogni task è identificato dal codice \texttt{T-y.z\textsubscript{G}} e riporta
obbligatoriamente i seguenti attributi:
 
\begin{itemize}
  \item assegnatario e ruolo;
  \item decisione di riferimento (codice \texttt{VI-y.x\textsubscript{G}} o \texttt{VE-y.x\textsubscript{G}});
  \item data di scadenza;
  \item stima del tempo previsto\textsubscript{G} (in minuti);
  \item tempo effettivo\textsubscript{G} consuntivato (in minuti);
  \item stato di avanzamento (\textit{To Do}, \textit{In Progress},
        \textit{Done}).
\end{itemize}
 
La creazione di un task avviene tramite \textbf{Google Form\textsubscript{G}}, che genera
...
\begin{enumerate}
  ...
  \item \textbf{Redazione del verbale}: il Redattore\textsubscript{G} incaricato compila il verbale
...
\begin{itemize}
  ...
  \item \textbf{GitHub}: sistema di controllo versione centralizzato per tutti i
        ...
        request e baseline\textsubscript{G}.
