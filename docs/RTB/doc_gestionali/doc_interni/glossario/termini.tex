...
\subsection*{C}
\begin{itemize}[leftmargin=*]
      \item \textbf{Candidatura (CC):} Fase iniziale del progetto didattico, antecedente all'aggiudicazione del capitolato, in cui il gruppo si propone come fornitore producendo la Valutazione dei Capitolati, la Lettera di Presentazione e il Preventivo Costi e Assunzione Impegni. Non è un documento, ma una baseline di fase.      \item \textbf{Cerimonie:} Insieme degli incontri strutturati previsti dal
      ...
      \item \textbf{Code Review:} Attività di revisione del codice sorgente svolta prima dell'integrazione nel branch principale. In fase RTB non è ancora pienamente normata, poiché la codifica è limitata al Proof of Concept; verrà formalizzata nella fase PB.
