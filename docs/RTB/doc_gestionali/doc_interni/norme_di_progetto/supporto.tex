...
\begin{itemize}
    \item \textbf{To Do\textsubscript{G}};
    \item \textbf{In Progress};
    \item \textbf{In Review\textsubscript{G}};
    \item \textbf{Done}.
\end{itemize}
...
Il processo di verifica assicura che ogni artefatto\textsubscript{G} prodotto sia conforme alle
...
\begin{itemize}
    \item è stato creato tramite Google Form\textsubscript{G};
...
Le metriche, le soglie e il cruscotto di qualità\textsubscript{G} sono definiti progressivamente
