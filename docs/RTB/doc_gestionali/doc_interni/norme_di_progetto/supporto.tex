...
\begin{itemize}
    ...
    \item \textbf{Pedice G\textsubscript{G}}: la prima occorrenza, nell'intero documento, di ogni
    termine presente nel Glossario deve essere marcata con il pedice
    . Lo script riceve in ingresso la concatenazione dei file
...
\subsubsection{Branch Protection Rules}\textsubscript{G}
...
\begin{itemize}
    ...
    \item \textbf{Check}: misurazione\textsubscript{G} dei risultati e analisi degli scostamenti;
