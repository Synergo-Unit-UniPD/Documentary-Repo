...
\begin{itemize}
  ...
  \item \textbf{Dichiarazione Degli Impegni}: contiene scadenza
        prevista, preventivo dei costi\textsubscript{G}, assegnazione di ore per ruolo, rischi attesi
...
pull~request\textsubscript{G}. La pull~request deve essere aperta \textbf{entro la domenica}
