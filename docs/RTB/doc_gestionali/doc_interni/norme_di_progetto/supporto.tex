...
\begin{itemize}
    ...
    \item \texttt{nome-documento} identifica il documento o l'artefatto\textsubscript{G} documentale
    coinvolto.
\end{itemize}
...
\paragraph{Scope\textsubscript{G} Documentali}
...
\begin{xltabular}{\textwidth}{
    ...
    & Misurare la percentuale di metriche di qualità che raggiungono il valore ottimale rispetto al totale delle metriche considerate. \\
