...
\begin{tabularx}{\textwidth}{l c X}
  ...
  Responsabile\textsubscript{G}
    ...
    & Coordina l'elaborazione di piani e scadenze; approva il rilascio di
      ...
      proponente; redige il verbale interno di ogni riunione; crea i task
      tramite Google Form durante la riunione. \\[6pt]
  Amministratore\textsubscript{G}
    ...
    & Assicura l'efficienza di procedure, strumenti e tecnologie a supporto
      ...
      Progetto; gestisce la creazione delle issue tramite Google Form; verifica,
  ...
  Analista\textsubscript{G}
    & 25\,€/h
    & Svolge le attività di analisi. \\[6pt]
...
nei task su GitHub Project.
 
\subsubsection{Pianificazione E Tracciamento Delle Attività}
 
Le attività sono tracciate tramite \textbf{GitHub Project}.
Ogni task corrisponde a una issue GitHub il cui identificativo numerico funge da codice univoco e riporta
...
\begin{itemize}
  ...
  \item stato di avanzamento (\textit{Backlog}, \textit{In Progress},
        \textit{Done}).
\end{itemize}
