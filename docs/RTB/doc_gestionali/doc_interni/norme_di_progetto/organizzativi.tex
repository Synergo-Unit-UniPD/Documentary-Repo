...
In conformità allo standard ISO/IEC~12207:1995\textsubscript{G}, i processi
...
conduzione degli sprint\textsubscript{G}, il tracciamento dell'avanzamento e il
...
sono riportate nel Piano di Progetto\textsubscript{G}.
...
In fase RTB\textsubscript{G}, il ruolo di Programmatore viene attivato solo per
attività di codifica limitate alla realizzazione del Proof of Concept\textsubscript{G}.
La piena attivazione del ruolo è prevista nella fase PB\textsubscript{G}.
...
\begin{xltabular}{\textwidth}{
    ...
    way of working\textsubscript{G}, mantiene le Norme di Progetto e gestisce
    ...
    Programmatore
    & 15\,\euro{}/h
    & Svolge attività di codifica. In RTB opera solo su eventuali parti di codice
    necessarie al Proof of Concept. \\
...
\begin{itemize}
    ...
    Forms\textsubscript{G}, Google Sheets\textsubscript{G}, GitHub Pages\textsubscript{G},
...
Durante lo sprint planning\textsubscript{G} il gruppo:
...
\begin{itemize}
    ...
    \item aggiorna il backlog dello sprint.
\end{itemize}
...
\begin{itemize}
    ...
    \item tempo previsto ed effettivo del Verificatore, se previsto;
...
\begin{itemize}
    ...
    \item analisi delle risorse residue.
\end{itemize}
...
Il foglio di calcolo condiviso produce automaticamente:
...
\begin{itemize}
    ...
    \item efficacia delle strategie di mitigazione adottate.
\end{itemize}
...
La riunione ha durata variabile, indicativamente tra due e quattro ore, in base
...
Il gruppo utilizza WhatsApp per aggiornamenti asincroni durante lo sprint.

Il daily stand-up asincrono viene utilizzato quando utile e deve riportare, se
necessario:

\begin{itemize}
    \item attività svolte;
...
\begin{itemize}
    ...
    \item \textbf{Google Calendar}: strumento per disponibilità, eventi ricorrenti e
...
Gli incontri con la proponente avvengono tramite Google Meet\textsubscript{G}.
...
\begin{enumerate}
    ...
    \item il verbale viene inviato alla proponente per firma o conferma;
...
\begin{itemize}
    ...
    \item incontri o colloqui previsti dal corso.
\end{itemize}
...
Gli strumenti e le tecnologie tecniche attualmente considerate per il Proof of
Concept includono:
