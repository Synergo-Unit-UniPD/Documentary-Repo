...
\begin{tabularx}{\textwidth}{l c X}
  ...
  Verificatore
    ...
    & Svolge le attività di verifica di documenti e codice prodotti dagli
      altri membri; redige i relativi esiti di verifica e il Piano di Qualifica. \\
  \bottomrule
\end{tabularx}
...
\begin{itemize}
  ...
  \item \textbf{Scadenza};
  \item \textbf{Tempo previsto} per il Redattore (in minuti);
...
inizio sprint, preventivo e consuntivo per lo sprint corrente e le risorse residue.
...
Le riunioni si svolgono in modalità remota sulla piattaforma Discord.
...
\begin{enumerate}
      \item \textbf{Sprint Retrospective}: il team identifica criticità nel processo
            di lavoro e definisce almeno un'azione correttiva concreta da applicare
            allo sprint successivo.
      \item \textbf{Sprint Review}: il team verifica
      ...
      \item \textbf{Sprint Planning}: il Responsabile aggiorna il backlog prioritario,
...
Il daily stand-up è gestito in modalità asincrona tramite il gruppo WhatsApp:
...
gestite tramite \textbf{Google Calendar}. I calendari condivisi
