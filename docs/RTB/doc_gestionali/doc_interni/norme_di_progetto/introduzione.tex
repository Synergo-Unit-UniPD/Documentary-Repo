...
La prima occorrenza dei termini presenti nel glossario viene marcata automaticamente tramite pedice  mediante uno script Python dedicato descritto nella Sezione~\ref{sec:strumenti-doc}.
...
\begin{itemize}
    ...
    \item i termini definiti nel Glossario sono marcati con il pedice alla prima occorrenza;
