...
Le norme qui descritte sono organizzate in conformità allo standard \textbf{ISO/IEC 12207:1995}, applicato secondo il processo di tailoring descritto nella Sezione~\ref{sec:tailoring}.

Le Norme di Progetto hanno i seguenti obiettivi:
\begin{itemize}
    \item definire il \textit{way of working} del gruppo;
...
Il documento è soggetto ad aggiornamento incrementale secondo il principio \textit{just-in-time}: ogni nuova attività deve essere normata prima della sua adozione operativa e ogni evoluzione significativa del progetto può comportare l'introduzione di nuovi processi o l'estensione di quelli esistenti.
...
Il prodotto sviluppato consiste in una piattaforma documentale intelligente basata su tecnologie AI e Large Language Models (LLM), finalizzata al supporto della scrittura e della gestione di note Markdown.
...
\begin{itemize}
    ...
    \item interfaccia utente moderna, accessibile e responsive.
\end{itemize}
...
\link{https://synergo-unit-unipd.github.io/Documentary-Repo/docs/RTB/doc_gestionali/doc_interni/glossario/glossario.pdf}
{Glossario}.
...
\begin{itemize}
    ...
    \item i riferimenti a file, branch, comandi e identificativi tecnici vengono riportati tramite font monospace mediante il comando \texttt{\textbackslash texttt\{\}};
...
\begin{itemize}
    ...
    \item
    \link{https://synergo-unit-unipd.github.io/Documentary-Repo/docs/ISO_12207-1995.pdf}
...
\begin{itemize}
    ...
    \item
    \link{https://synergo-unit-unipd.github.io/Documentary-Repo/docs/RTB/doc_gestionali/doc_esterni/piano_di_progetto/piano_di_progetto.pdf}
    {Piano di Progetto};

    \item
    \link{https://synergo-unit-unipd.github.io/Documentary-Repo/docs/RTB/doc_gestionali/doc_esterni/piano_di_qualifica/piano_di_qualifica.pdf}
    {Piano di Qualifica};

    \item
    \link{https://synergo-unit-unipd.github.io/Documentary-Repo/docs/RTB/doc_tecnici/doc_esterni/analisi_dei_requisiti/analisi_dei_requisiti.pdf}
    {Analisi dei Requisiti};

    \item
    \link{https://synergo-unit-unipd.github.io/Documentary-Repo/docs/RTB/doc_gestionali/doc_interni/analisi_stato_arte/analisi_stato_arte.pdf}
...
\begin{itemize}
      ...
      \item \textbf{Processi di Supporto}: descrive i processi che supportano lo sviluppo, la qualità, la documentazione e la gestione della configurazione;
