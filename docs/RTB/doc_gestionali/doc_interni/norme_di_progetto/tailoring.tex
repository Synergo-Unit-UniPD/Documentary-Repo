...
\subsection{Processi Pianificati Per La Fase PB}\textsubscript{G}
...
\begin{itemize}
    ...
    \item code review\textsubscript{G};
    \item integrazione continua\textsubscript{G};
    \item testing automatico;
    \item analisi dinamica del codice;
    \item deployment automatizzato\textsubscript{G};
