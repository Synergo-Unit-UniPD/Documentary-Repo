...
funzione dell'evoluzione del progetto e delle baseline previste
dal Regolamento del Progetto Didattico.

Il tailoring adottato tiene conto dei seguenti fattori contestuali:

\begin{itemize}
    \item \textbf{Baseline attuale}: RTB; il gruppo si trova nella
...
candidatura (CC), mantenuti operativi anche nelle fasi successive
del progetto.
...
tecnologiche e all'implementazione dimostrativa del Proof of Concept.
...
dello sviluppo esteso e dalla produzione del Minimum Viable Product.
