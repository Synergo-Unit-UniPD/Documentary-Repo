...
Baseline\textsubscript{G}; non costituisce ancora il prodotto completo previsto
...
\begin{xltabular}{\textwidth}{
    ...
    Primario
    & Processo di Sviluppo: Implementazione del Proof of Concept
    & \ref{sec:sviluppo} \\
...
\begin{itemize}
    ...
    \item norme di codifica complete;
