...
\begin{itemize}
  \item \textbf{Baseline\textsubscript{G} attuale}: RTB\textsubscript{G}; il gruppo è in fase di
        analisi dei requisiti e produzione della documentazione tecnica e gestionale
        richiesta per la Requirements \& Technology Baseline.
...
La tabella seguente elenca i processi attivati nella fase di candidatura (CC),
