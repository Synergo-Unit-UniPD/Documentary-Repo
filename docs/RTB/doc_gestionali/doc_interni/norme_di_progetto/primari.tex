...
La realizzazione del PoC\textsubscript{G} può prevedere attività di codifica limitate e finalizzate
...
\paragraph{Stack tecnologico\textsubscript{G} individuato}
...
funzionalità individuate dal gruppo per la Requirements \& Technology Baseline.
...
\begin{itemize}
    ...
    \item distant writing tramite inserimento di prompt\textsubscript{G}.
\end{itemize}
