...
Lo stack tecnologico\textsubscript{G} attualmente individuato per il Proof of Concept comprende:

\begin{itemize}
    \item \textbf{Frontend\textsubscript{G}}: Vue.js con CodeMirror\textsubscript{G};
    \item \textbf{Backend\textsubscript{G}}: Python con FastAPI;
    \item \textbf{Containerizzazione}: Docker\textsubscript{G} e Docker Compose\textsubscript{G}.
\end{itemize}
