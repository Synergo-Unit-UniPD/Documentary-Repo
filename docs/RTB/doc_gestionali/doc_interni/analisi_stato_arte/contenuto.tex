...
\begin{itemize}
    \item \link{https://vuejs.org/}{Vue.js Guide e API Reference};

    \item \link{https://codemirror.net/}{CodeMirror Documentation};

    \item \link{https://fastapi.tiangolo.com/}{FastAPI Documentation};

    \item \link{https://www.postgresql.org/docs/}{PostgreSQL Documentation};

    \item \link{https://docs.docker.com/}{Docker Documentation}.
\end{itemize}
