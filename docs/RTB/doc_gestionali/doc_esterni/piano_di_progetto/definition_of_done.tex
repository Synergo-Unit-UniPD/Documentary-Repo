...
considerato completato. Non ``quasi finito'' o ``funziona in locale'': finito davvero.
Si applica a due livelli distinti e si \textbf{espande} al crescere del progetto: la
Sez.~\ref{sec:dod-doc} è attiva fin dal primo sprint; la Sez.~\ref{sec:dod-codice}
verrà attivata quando il team inizierà lo sviluppo del PoC.
