...
\begin{itemize}
    ...
    \item pianificare le attività nel breve e nel lungo termine con milestone;
...
\begin{itemize}
	\item \textbf{RTB (Requirements and Technology Baseline):} {Marzo-Giugno}
	\item \textbf{PB (Product Baseline):} {Giugno-Agosto}
\end{itemize}