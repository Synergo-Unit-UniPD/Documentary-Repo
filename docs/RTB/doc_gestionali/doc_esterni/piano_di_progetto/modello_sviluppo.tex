...
\begin{enumerate}
    \item \textbf{Sprint Retrospective\textsubscript{G}} dello sprint precedente: cosa ha funzionato,
    ...
    \item \textbf{Sprint Planning\textsubscript{G}}: aggiornamento del backlog prioritario, stima del
          tempo previsto\textsubscript{G}, assegnazione dei task tramite Google Form\textsubscript{G}.
