...
Durante la fase RTB non sono previsti test automatici obbligatori sul codice. La verifica del codice riguarda esclusivamente il Proof of Concept e viene svolta manualmente tramite Pull Request, controllando la coerenza con la issue, l'avvio locale, l'assenza di errori evidenti e l'assenza di credenziali o file sensibili nel repository.
 Le attività di verifica del codice inizieranno nella fase di Product Baseline (PB) non appena verrà avviata la stesura dei primi moduli software.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|X|c|c|}
        ...
        \hline
        MPC04 & Time Efficency & 75\% & Accettabile \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|X|c|c|}
        ...
        \hline
        MPD02 & Comment Density &   &   \\
        \hline
        MPD03 & Browser Compatibility &   &   \\
        \hline
        MPD04 & Errori Ortografici (per pagina) & 0 & Ottimale \\
        \hline
        MPD05 & Complessità Ciclomatica &   &   \\
        \hline
        MPD06 & Tempo di Caricamento Iniziale &   &   \\
        \hline
        MPD07 & Indice di Gulpease (Media Documenti) & 148 & Ottimale \\
        \hline
    \end{tabularx}
