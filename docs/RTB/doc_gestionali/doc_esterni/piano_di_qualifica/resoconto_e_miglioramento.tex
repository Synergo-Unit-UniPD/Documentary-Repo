...
Il dato più rilevante emerge dalla Budget Variance. Dopo otto sprint di passivo (culminati nel picco negativo dello sprint 6), negli sprint 9 e 10 le colonne della BV passano nettamente in territorio positivo. Nello sprint 9 si registra un avanzo di ben +123,75~\euro, seguito da un +53,75~\euro\ nello sprint 10; infine si torna ad un regime più paritario nello sprint 11 con +0,00~\euro\ . Questa marcata ripresa conferma il superamento delle criticità passate e un'eccellente capacità del team di completare i task risparmiando sul budget orario stimato.
...
Il CPI mostra un andamento in forte riscatto. Dopo il crollo sotto lo 0,60 durante lo sprint 6 e la fase di stabilizzazione successiva, l'indice supera finalmente la soglia ottimale di 1,0. Nello sprint 9 il CPI vola a 1,24, assestandosi poi a 1,10 nello sprint 10 per poi tornare a 1,0 nello sprint 11. La combinazione di questi due indici (SPI a 1,0 e CPI $> 1,0$) indica non solo il rispetto rigoroso delle scadenze, ma un'efficienza di costo superiore alle aspettative iniziali.
...
Grazie alle eccellenti performance economiche degli sprint 9 e 10, la curva dell'EAC è scesa per la prima volta al di sotto della soglia di sicurezza del budget (BAC), attestandosi rispettivamente a 9.401~\euro\ nello sprint 9 e a 10.534~\euro\ nello sprint 10 per poi infine tornare in pari con il BAC nello sprint 11 con 11.665~\euro\ . Questi dati confermano che il gruppo, assorbiti i rallentamenti della stesura iniziale, è ora proiettato verso una chiusura economica del progetto pienamente in attivo.
...
Nel corso degli sprint si osserva un miglioramento costante del valore, frutto delle continue attività di revisione, che si stabilizza sul risultato attuale di 51,63. 
...
Il trend positivo si conferma negli ultimi sprint, portando l'Indice di Gulpease all'attuale valore di 55,40.
