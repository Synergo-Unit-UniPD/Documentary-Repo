...
Dal grafico si osserva una perfetta sovrapposizione tra la curva del PV e quella dell'EV lungo tutti e 11 gli sprint: questo indica che il gruppo è riuscito a completare costantemente il 100\% del lavoro pianificato per ogni iterazione, rispettando in pieno le tempistiche.

Tuttavia, la vera svolta si osserva analizzando l'Actual Cost (AC). Dopo il picco anomalo di spesa dello sprint 6 e il progressivo recupero di efficienza degli sprint 7 e 8, nelle iterazioni 9 e 10 si registra un'inversione di tendenza estremamente positiva infine per i sprint 11 e 12 rimane stabile e a ribasso in confronto al periodo precendente per via di esami e del periodo di attesa per la valutazione RTB. Per la prima volta, i costi sostenuti scendono al di sotto del valore prodotto: nello sprint 9 l'AC si attesta a 513,75~\euro\ a fronte di un EV di 637,50~\euro\, dinamica che si ripete nello sprint 10 con un AC di 501,25~\euro\ contro un EV di 555,00~\euro\ e si arriva allo sprint 11 e 12 dove rimane in pari con il valore del prodotto con 90,00~\euro\ di AC e 90,00~\euro\ di EC nello sprint 11 e 112,08~\euro\ di AC e 112,92~\euro\ di EC nello sprint 12. Questo dimostra che il team ha ottimizzato il lavoro, assorbendo il debito precedente e operando in pieno risparmio rispetto alle proiezioni.
...
Il dato più rilevante emerge dalla Budget Variance. Dopo otto sprint di passivo (culminati nel picco negativo dello sprint 6), negli sprint 9 e 10 le colonne della BV passano nettamente in territorio positivo. Nello sprint 9 si registra un avanzo di ben +123,75~\euro, seguito da un +53,75~\euro\ nello sprint 10; infine si torna ad un regime più paritario nello sprint 11 e 12. Questa marcata ripresa conferma il superamento delle criticità passate e un'eccellente capacità del team di completare i task risparmiando sul budget orario stimato.
...
Il CPI mostra un andamento in forte riscatto. Dopo il crollo sotto lo 0,60 durante lo sprint 6 e la fase di stabilizzazione successiva, l'indice supera finalmente la soglia ottimale di 1,0. Nello sprint 9 il CPI vola a 1,24, assestandosi poi a 1,10 nello sprint 10 per poi tornare a 1,0 nello sprint 11 e 12. La combinazione di questi due indici (SPI a 1,0 e CPI $> 1,0$) indica non solo il rispetto rigoroso delle scadenze, ma un'efficienza di costo superiore alle aspettative iniziali.
...
Grazie alle eccellenti performance economiche degli sprint 9 e 10, la curva dell'EAC è scesa per la prima volta al di sotto della soglia di sicurezza del budget (BAC), attestandosi rispettivamente a 9.401~\euro\ nello sprint 9 e a 10.534~\euro\ nello sprint 10 per poi infine tornare in pari con il BAC nello sprint 11 con 11.665~\euro\ e rimanendo stabile nello sprint 12. Questi dati confermano che il gruppo, assorbiti i rallentamenti della stesura iniziale, è ora proiettato verso una chiusura economica del progetto pienamente in attivo.
...
Nel corso degli sprint si osserva un miglioramento costante del valore, frutto delle continue attività di revisione, che si stabilizza sul risultato attuale di 51,75. 
...
Il trend positivo si conferma negli ultimi sprint, portando l'Indice di Gulpease all'attuale valore di 50,49.
