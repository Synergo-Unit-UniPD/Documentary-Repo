...
Il gruppo adotta lo standard \textbf{ISO/IEC 12207} per la gestione dei processi. La qualità è perseguita attraverso il monitoraggio costante di indicatori quantitativi calcolati al termine di ogni Sprint.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|X|c|c|}
        ...
        \hline
        MPC01 & \textbf{Schedule Performance Index (SPI)}: efficienza nel rispettare i tempi pianificati. & $\ge 0.9$ & $1.0$ \\
        \hline
        MPC02 & \textbf{Cost Performance Index (CPI)}: efficienza nell'uso del budget allocato. & $\ge 0.9$ & $1.0$ \\
        \hline
        MPC03 & \textbf{Requirements Stability Index (RSI)}: variazione dei requisiti nell'Analisi. & $\ge 80\%$ & $100\%$ \\
        \hline
        MPC04 & \textbf{Time Efficiency}: percentuale di ore produttive sul totale ore spese. & $\ge 75\%$ & $\ge 90\%$ \\
        \hline
        MPC05 & \textbf{Task Completion Rate}: percentuale di issue chiuse rispetto a quelle pianificate. & $\ge 80\%$ & $100\%$ \\
        \hline
        MPC06 & \textbf{PR Resolution Time}: tempo medio per revisione e merge di una Pull Request. & $\le 3 \text{ giorni}$ & $\le 1 \text{ giorno}$ \\
        \hline
