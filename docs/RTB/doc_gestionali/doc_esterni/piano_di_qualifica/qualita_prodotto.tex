...
\begin{itemize}
	...
	\item \textbf{Usabilità}: facilità d'uso dell'interfaccia Markdown e della chat.
	\item \textbf{Efficienza}: tempi di risposta delle chiamate alle API dell'LLM.
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|X|c|c|}
        ...
        \hline
        MPD03 & \textbf{Code Coverage}: percentuale di linee di codice coperte da test automatici. & $\ge 70\%$ & $\ge 90\%$ \\
        \hline
