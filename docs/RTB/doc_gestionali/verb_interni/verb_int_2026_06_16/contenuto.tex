...
\item stesura del quinto Diario di Bordo\textsubscript{G};
...
\begin{longtable}{c p{12cm}}
    ...
    \textbf{VI-18.4} & Viene avviato lo Sprint 11, comprendente l'aggiornamento dei documenti gestionali (PdP e PdQ) con i dati dello Sprint 10 e la stesura del verbale interno e del quinto Diario di Bordo.\\[4pt]
