...
\begin{enumerate}
	...
	\item Pianificazione dello sprint successivo e assegnazione dei task e ruoli.
\end{enumerate}
...
delle criticità riguardanti il Piano di Progetto in particolare nell'aggiornamento delle tabelle 
...
Infine il gruppo ha deciso di sviluppare il template per il diario di bordo.
...
riscrittura dei vari casi d'uso nel caso emergessero molte criticità e sull'avanzamento della stesura del 
...
Responsabile (Filippo Idiometri), Amministratore (Anton R. Rupi), Verificatore (Sofia De Blasi), 
Analisti (Armando M. Scarati, Roberto M. Doroftei, Francesco Marcon).
Come nei precedenti sprint, i ruoli di Programmatore e Progettista non sono ancora necessari e si è quindi 
deciso nuovamente di dedicare 3 membri al ruolo dell'Analista, in particolare Armando e Roberto riguardo all'
...
\begin{itemize}
	...
	\begin{itemize}
		\item Revisione e verifica dei task del quarto sprint;
