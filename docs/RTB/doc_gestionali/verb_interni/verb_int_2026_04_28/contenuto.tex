...
\begin{itemize}
	\item \textbf{Luogo/Piattaforma:} Server Discord\textsubscript{G}\textsubscript{G}\textsubscript{G}
	\item \textbf{Data:} 2026-04-28
	\item \textbf{Orario di inizio:} 14:30
	\item \textbf{Orario di fine:} 17:40
	\item \textbf{Responsabile\textsubscript{G}\textsubscript{G}\textsubscript{G}:} Filippo Idiometri
...
\begin{enumerate}
	\item Sprint\textsubscript{G}\textsubscript{G}\textsubscript{G} review e retrospective,
	\item Messa in pari sulla stesura dell'AdR e del PdP,
	\item Pianificazione dello sprint successivo e assegnazione dei task\textsubscript{G}\textsubscript{G}\textsubscript{G} e ruoli.
\end{enumerate}

% --- 3. RESOCONTO E DISCUSSIONE ---
\section{Resoconto della Riunione}

\subsection{Sprint review\textsubscript{G}\textsubscript{G}\textsubscript{G} e retrospective}
Il gruppo si è confrontato sull'andamento dello sprint appena terminato. Sono state segnalate
delle criticità riguardanti il Piano di Progetto\textsubscript{G}\textsubscript{G}\textsubscript{G} in particolare nell'aggiornamento delle tabelle 
...
Infine il gruppo ha deciso di sviluppare il template\textsubscript{G}\textsubscript{G}\textsubscript{G} per il diario di bordo.
...
che il gruppo ha deciso di usare come domande da porre al colloquio con il professor Cardin.
A seconda dall'andamento del colloquio il gruppo ha deciso di soffermarsi solamente sulla correzione e 
riscrittura dei vari casi d'uso\textsubscript{G}\textsubscript{G}\textsubscript{G} nel caso emergessero molte criticità e sull'avanzamento della stesura del 
...
Responsabile (Filippo Idiometri), Amministratore\textsubscript{G}\textsubscript{G}\textsubscript{G} (Anton R. Rupi), Verificatore\textsubscript{G}\textsubscript{G}\textsubscript{G} (Sofia De Blasi), 
Analisti (Armando M. Scarati, Roberto M. Doroftei, Francesco Marcon).
Come nei precedenti sprint, i ruoli di Programmatore\textsubscript{G}\textsubscript{G}\textsubscript{G} e Progettista\textsubscript{G}\textsubscript{G}\textsubscript{G} non sono ancora necessari e si è quindi 
deciso nuovamente di dedicare 3 membri al ruolo\textsubscript{G}\textsubscript{G}\textsubscript{G} dell'Analista\textsubscript{G}\textsubscript{G}\textsubscript{G}, in particolare Armando e Roberto riguardo all'
Adr e Francesco riguardo al PdP (inserimento del nuovo sprint).
% --- 4. DECISIONI PRESE ---
...
\begin{longtable}{c c p{4.5cm} p{3cm} l}
	...
	% Issue\textsubscript{G}\textsubscript{G}\textsubscript{G} #137 - Aggiornamento AdR
	...
	\ghissue{138} & - & Aggiornamento delle note di progetto & Sofia De Blasi & 2026-05-05 \\[4pt]
...
\begin{itemize}
	...
	\item \textbf{OdG preliminare\textsubscript{G}\textsubscript{G}\textsubscript{G}:}
	\begin{itemize}
		\item Revisione\textsubscript{G}\textsubscript{G}\textsubscript{G} e verifica dei task del quarto sprint;
		\item Avanzamento del Piano di Progetto;
		\item Avanzamento dell'Analisi dei Requisiti\textsubscript{G}\textsubscript{G}\textsubscript{G};
