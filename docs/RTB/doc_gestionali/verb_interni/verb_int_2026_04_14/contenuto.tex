...
la creazione delle issue\textsubscript{G}, gestire la 
comunicazione con l'azzienda referente e controlla, 
...
\begin{itemize}
	...
	\begin{itemize}
		\item Revisione e verifica dei task del primo secondo sprint;
