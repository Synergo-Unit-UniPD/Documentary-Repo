...
\begin{longtable}{c c p{4.5cm} p{3cm} l}
    ...
    \href{https://github.com/Synergo-Unit-UniPD/Second-Brain/issues/93}{\underline{\#93}} & VI-9.7
    ...
    \href{https://github.com/Synergo-Unit-UniPD/Second-Brain/issues/94}{\underline{\#94}} & VI-9.1
        & {Stesura verbale interno della riunione odierna.
           (Revisore: Ricardo)}
        & Sofia De Blasi & 2026-04-07 \\[4pt]

    \href{https://github.com/Synergo-Unit-UniPD/Second-Brain/issues/95}{\underline{\#95}} & VI-9.5
        & {Configurazione campi precompilati Google Form per nomenclatura
           task e branch.}
        & Francesco Marcon & 2026-04-07 \\[4pt]

    \href{https://github.com/Synergo-Unit-UniPD/Second-Brain/issues/96}{\underline{\#96}} & --
    ...
    \href{https://github.com/Synergo-Unit-UniPD/Second-Brain/issues/97}{\underline{\#97}} & --
        & {Studio struttura e contenuto del Piano di Progetto.}
        & Anton Ricardo Rupi, Francesco Marcon, Sofia De Blasi & 2026-04-07 \\[4pt]
	
	\href{https://github.com/Synergo-Unit-UniPD/Second-Brain/issues/99}{\underline{\#99}} & --
