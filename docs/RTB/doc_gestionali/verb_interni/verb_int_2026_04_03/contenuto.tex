...
\begin{enumerate}
	\item Pianificazione della documentazione da produrre nella fase RTB:
	      Analisi dei Requisiti, Piano di Progetto, Piano di Qualifica,
	      Norme di Progetto.
	\item Scelta delle tecnologie per il progetto.
	\item Aggiornamento delle convenzioni operative: gestione di task,
	      branch, commit e pull request.
	\item Revisione e aggiornamento del template documentale.
\end{enumerate}
...
Il documento costituisce la base della fase RTB e include la definizione dei casi d'uso, con relativa
rappresentazione tramite diagrammi UML. Il gruppo ha stabilito di studiare
preventivamente il materiale del corso prima di avviare la stesura.

\paragraph{Piano di Progetto}
Il documento regolerà la gestione del progetto tramite sprint, includendo
le attività di sprint planning, sprint review e sprint retrospective,
...
il principio just-in-time già adottato. In questa sessione sono state
...
(HTML, CSS, Markdown e API compatibili con le specifiche OpenAI) e ha
...
Requisiti. La definizione della technology baseline — obiettivo della
...
Il branch viene creato direttamente dalla pagina della issue su GitHub
...
\begin{enumerate}
	\item Il Responsabile crea il task tramite Google Form durante la riunione.
	\item Il Redattore del verbale di riunione inserisce il riferimento alla issue nel verbale
	...
	\item Il Verificatore effettua la revisione; l'Assegnatario (non il Verificatore)
	      esegue il merge dopo l'approvazione.
...
\begin{longtable}{c c p{4.5cm} p{3cm} l}
    ...
    \href{https://github.com/Synergo-Unit-UniPD/Documentary-Repo/issues/97}{\underline{\#97}} & --
        ...
        & Anton Ricardo Rupi, Francesco Marcon, Sofia De Blasi & 2026-04-07 \\
\end{longtable}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Ragionare sulla gestione di task non strettamente legate
		      alla repository e con più assegnatari (es.\ studio individuale (tempo di palestra),
