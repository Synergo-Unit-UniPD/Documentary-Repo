% Conteggio requisiti:
% Funzionali Obbligatori: R1..R77-F-O = 76 requisiti
% Funzionali Desiderabili: R55-F-D = 1 requisito
% Funzionali Opzionali: R78..R83-F-Op = 6 requisiti
...
% Totale Obbligatori: 76 + 3 + 6 + 1 = 86
...
\begin{table}[ht]
	...
	\begin{tabularx}{0.8\textwidth}{|l|X|}
		...
		Prestazionali & 1 \\
		\hline
		\textbf{Totale Obbligatori} & \textbf{86} \\
		\hline
	\end{tabularx}
