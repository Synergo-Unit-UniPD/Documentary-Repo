...
\begin{longtable}{|p{2.5cm}|p{2.2cm}|p{6.8cm}|p{2.7cm}|}
	...
	\textbf{R1-Q-O} & Obbligatorio & Il sistema dovrà essere corredato di test automatici con copertura adeguata dei casi d'uso principali. & Capitolato \\ \hline
...
\begin{longtable}{|p{2.5cm}|p{2.2cm}|p{6.8cm}|p{2.7cm}|}
	...
	\textbf{R6-V-Op} & Opzionale & Nel caso venga implementata la persistenza remota, il sistema dovrà supportare PostgreSQL\textsubscript{G} come DBMS di riferimento. & VE-1.4 \\ \hline
...
\begin{longtable}{|p{2.5cm}|p{2.2cm}|p{6.8cm}|p{2.7cm}|}
	...
	\textbf{R2-P-O} & Obbligatorio & Il sistema deve fornire un feedback visivo (es.\ indicatore di caricamento) durante le operazioni AI la cui durata superi i 2 secondi. & Analisi del dominio, VE-6.1 \\ \hline
