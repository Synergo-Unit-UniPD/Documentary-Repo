...
\begin{itemize}
    ...
    \item \textbf{Supporto AI e Manipolazione Testo}: Funzioni di riassunto, traduzione multilingua e riscrittura parametrica (es. correzione grammaticale, cambio del tono in formale o colloquiale, estensione o sintesi del contenuto).
...
\begin{itemize}
	\item \textbf{Vincoli Tecnologici e Architetturali}: L'applicazione deve essere basata su tecnologie web standard (HTML, browser). L'interazione con i modelli LLM (es. Gemini, Mistral, Gemma) deve avvenire tramite chiamate API aderenti allo standard OpenAI. Lo sviluppo richiede l'adozione di pattern architetturali robusti e duttili, atti a supportare continue revisioni incrementali.
